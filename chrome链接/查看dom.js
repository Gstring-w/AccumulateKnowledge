javascript: (function SpyOn() {
  ...
  function init() {
    document.body.addEventListener("mousemove", glide,false);
    document.body.addEventListener("mouseover", show,false);
    document.body.addEventListener("mouseleave", hide,false);
  }
  function removeEvent() {
    document.body.removeEventListener("mousemove", glide,false);
    document.body.removeEventListener("mouseover", show,false);
    document.body.removeEventListener("mouseleave", hide,false);
  }
  function hide(e) {
  ...
  if (!window.DEMO_SHOW_TEXT_091qws) {
    window.DEMO_SHOW_TEXT_091qws = 1;
    init();
  } else {
    window.DEMO_SHOW_TEXT_091qws = false;
    removeEvent();
  }
})();
