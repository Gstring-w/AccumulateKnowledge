javascript: (function SpyOn() {
  ...
  function CreateText(){
      var text = typeof JS_AlipayJSBridge_TEXT == 'undefined' ? document.createElement('textarea') : JS_AlipayJSBridge_TEXT;
      ...
      var btn = typeof JS_AlipayJSBridge_BUTTON == 'undefined' ? document.createElement('button') : JS_AlipayJSBridge_BUTTON;
